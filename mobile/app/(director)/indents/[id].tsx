...
export default function DirectorIndentDetails() {
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                {indent.purchaseApprovedBy && (
                    <Text style={styles.approval}>
                        Purchase Approved: {indent.purchaseApprovedBy.name}
                    </Text>
                )}
            </View>
            ...
            {canApprove && (
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Final Approval</Text>
                    <TextInput
                    ...
                    >
                        {approving ? (
                            ...
                            <Text style={styles.approveButtonText}>Approve for Order</Text>
                        )}
                    </TouchableOpacity>
