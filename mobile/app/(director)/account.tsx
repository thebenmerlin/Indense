        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                <View style={styles.profileCard}>
                    ...
                    <View style={styles.roleBadge}><Text style={styles.roleText}>DIRECTOR</Text></View>
                </View>
...
const styles = StyleSheet.create({
    ...
    profileCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 24 },
    avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#059669', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
    ...
    roleBadge: { backgroundColor: '#D1FAE5', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
    roleText: { fontSize: 12, color: '#059669', fontWeight: '600' },
    logoutButton: { backgroundColor: '#FEE2E2', borderRadius: 12, paddingVertical: 16, alignItems: 'center' },
