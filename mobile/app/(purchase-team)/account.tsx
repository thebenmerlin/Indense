        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                <View style={styles.profileCard}>
                    ...
                    <View style={styles.roleBadge}><Text style={styles.roleText}>PURCHASE TEAM</Text></View>
                </View>
...
const styles = StyleSheet.create({
    ...
    roleBadge: { backgroundColor: '#EDE9FE', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
    roleText: { fontSize: 12, color: '#8B5CF6', fontWeight: '600' },
